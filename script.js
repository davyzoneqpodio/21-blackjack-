(function(){
  ...
  function renderGame(state, kind){
    const isCampaign=kind==='campaign'; const title=isCampaign?(state.challenge?.name||'Campanha'):'Online contra a mesa';
